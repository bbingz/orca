...
// Why: dispatch inspection now requires Run-scoped caller attestation; newer
// clients must fence the read before talking to an older host that drops it.
export const ORCHESTRATION_DISPATCH_SHOW_SCOPE_RUNTIME_CAPABILITY =
  'orchestration.dispatch-show-run-scope.v1' as const
