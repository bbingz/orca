...
export function getProjectProviderIdentity(
  ...
  // Why: probed remote identity is authoritative and refreshed on renames/transfers,
  // whereas cached avatar icons can become stale and split projects across hosts.
  const fromRemote =
